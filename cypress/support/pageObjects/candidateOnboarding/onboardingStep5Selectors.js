class OnboardingStepFivePage {
  ...
  getVaricellaProofField() {
    return cy.get('', { timeout: 10000 })
  }

  getTuberculosisProofField() {
    return cy.get('', { timeout: 10000 })
  }

  getRubellaProofField() {
    return cy.get('', { timeout: 10000 })
  }

  getHepatitisBProofField() {
    return cy.get('', { timeout: 10000 })
  }

  //Proof of Immunity - EPP Candidates Only

  getHepatitisB_SurfaceAntigenField() {
    return cy.get('', { timeout: 10000 })
  }
...
export default OnboardingStepFivePage
